...
- [4) Using the app (what ton click)](#4-using-the-app-what-to-click)
...
By default this projectis set up to call a real API at:
...
- `src/environments/environmnet.prod.ts` (production build)
...
4. Click the verification link (or pass it in the browser) to verify your account

### B) Login

1. Go to Login
2. Enter your email + password
3. On success you'll be redurected to the home page
